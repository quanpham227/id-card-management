...
const DashboardHeader = ({ 
  ...
  return (
    <Flex vertical gap="middle" style={{ marginBottom: 20, background: '#fff', padding: '20px', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>
      
      {/* HÀNG 1: Tiêu đề và Các nút hành động */}
      <Flex justify="space-between" align="center" wrap="wrap" gap="middle">
        <Flex vertical gap={0}>
          <Title level={4} style={{ margin: 0 }}>
            {viewStatus === 'Active' ? 'Active Employees' : (viewStatus === 'All' ? 'All Employees' : 'Resigned Employees')}
          </Title>
